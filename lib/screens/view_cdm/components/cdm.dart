...
List<SearchModel> procedures_list = [
  SearchModel.withoutName('ROOM/BED: Newborn Routine', '3172.4', 'Standard'),
  SearchModel.withoutName('Lung Transplant', '4000', 'DRG'),
  SearchModel.withoutName('Heart Failure', '5800', 'DRG'),
  SearchModel.withoutName('Kidney Transplant Paired Donor', '20008', 'DRG'),
  SearchModel.withoutName('ALTEPLASE 100MG SOLR 1 EACH VIAL', '3801.76', 'Pharmacy')
];
