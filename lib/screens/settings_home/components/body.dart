                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Row(
                       ...
                       context.bloc<HomeSettingsBloc>().add(ToggleOrder(HomeSettingsModel(state.homeSettingsModel.radius,state.homeSettingsModel.order,value)));
                            },
            ...
            child: Row(
              ...
              new Expanded(
                ...
                onChanged: (double newValue) {
                  context.bloc<HomeSettingsBloc>().add(ChangeRadius(HomeSettingsModel(newValue.toInt(),state.homeSettingsModel.order,state.homeSettingsModel.isSelected)));
                },
              )),
            ])),
      ),
