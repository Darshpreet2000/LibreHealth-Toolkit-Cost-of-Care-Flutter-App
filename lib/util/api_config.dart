class ApiConfig{
  ...
  String downloadCDMApi="https://gitlab.com/Darshpreet2000/lh-toolkit-cost-of-care-app-data-scraper/-/raw/branch-with-data/CDM";
  ...
  String gitlabApiGetCDMFileSize="https://gitlab.com/api/v4/projects/18885282/repository/files/CDM";

   // Google API
  // Getting First image from Google by searching hospital name
  String getHospitalImageFromGoogle = 'https://www.google.com/search?tbm=isch&q=';

  //Overpass API
  // Using Overpass API to get nearby hospitals
  String nearbyHospitalApi = "https://lz4.overpass-api.de/api/interpreter?data=";
